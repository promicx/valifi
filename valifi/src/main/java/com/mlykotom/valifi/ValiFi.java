...
public class ValiFi {
    ...
    public static class ValiFiConfig {
        ...
        ValiFiConfig(ValiFieldBase.PropertyValidator<String>[] validators, @StringRes int[] errorResources, long errorDelay, @NonNull Set<ValiFiCardType> knownCardTypes) {
    ...
    public static class Builder {
        ...
        public ValiFiConfig build() {
            return new ValiFiConfig(mValidators, mErrorResources, mErrorDelay, mKnownCardTypes);
        }
